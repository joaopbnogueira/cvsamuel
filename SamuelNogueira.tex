...
\cvproject{Despeja Palox Automatizado}{Projeto final de curso}{18 valores}
...
\cvtag{SolidWorks} \cvtag{Siemens TiaPortal} \\

\divider

\cvproject{Saca-Rolhas}{Projeto Laboratórios de Eng. de Produção}{17 valores}
...
\cvtag{SolidWorks} \cvtag{MastercamCAM} \\

\divider

\cvproject{Vaso}{Projeto de Fabrico de Moldes}{14 valores}
